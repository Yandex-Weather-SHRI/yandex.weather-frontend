  ...
  switch (name) {
    case categoryGroup.allergy:
      return css`
        ...
        box-shadow:
          0 2px 4px 0 rgba(255, 204, 0, 0.07),
          0 2px 8px 0 rgba(95, 227, 143, 0.55);
      `
    ...
    case categoryGroup.ultraviolet:
      return css`
        ...
        box-shadow:
          0 2px 10px 0 rgba(255, 151, 88, 0.0),
          0 2px 17px 0 rgba(255, 151, 88, 0.35);
      `
